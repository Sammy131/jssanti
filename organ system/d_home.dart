...
import 'package:flutter_complete_guide/organ%20system/d1.dart';
import 'package:flutter_complete_guide/organ%20system/d2.dart';
import 'package:flutter_complete_guide/organ%20system/d3.dart';
                    ...
                    child: ListTile(
                      ...
                      onTap: () {
                        Navigator.of(context).push(MaterialPageRoute(
                            builder: (BuildContext context) => D1()));
                      },
                    ),
                  ),
                  Card(
                    child: ListTile(
                      ...
                      onTap: () {
                        Navigator.of(context).push(MaterialPageRoute(
                            builder: (BuildContext context) => D2()));
                      },
                    ),
                  ),
                  Card(
                    ...
                    child: ListTile(
                      //tileColor: Color.fromARGB(255, 217, 148, 64),
                      title: Text("3. Necrotizing fasciitis"),
                      subtitle: Text(""),
                      /*leading: CircleAvatar(
                        backgroundImage: NetworkImage(
                      ...
                      onTap: () {
                        Navigator.of(context).push(MaterialPageRoute(
                            builder: (BuildContext context) => D3()));
                      },
                    ),
                  ),
                ],
