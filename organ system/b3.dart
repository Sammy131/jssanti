...
class _B3State extends State<B3> {
  ...
  List<ItemModel> itemData = <ItemModel>[
    ...
    ItemModel(
      ...
      colorsbody: Colors.black,
      discription:
          "Likely Causative Organisms:\n• S.pneumoniae\n• H. influenzae\n\nEmpirical/First Line:\n• Ceftriaxone 2gm IV 12 hourly (For 14 days)\n\nComments:\n• Dexamethasone 0.15mg/kg IV 6 hourly for 2-4 days (1st dose with or before first antibiotic dose)",
      img: '',
      //'assets/b3alt.png',
    ),
  ];
