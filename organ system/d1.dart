...
class _D1State extends State<D1> {
  ...
  List<ItemModel> itemData = <ItemModel>[
    ItemModel(
      ...
      discription:
          "Acute bacterial infection of the skin and subcutaneous tissue. Most common causes of cellulitis are Streptococcus pyogenes and Staphylococcus aureus.",
    ...
    ItemModel(
      ...
      discription:
          "SYMPTOMS AND SIGNS:\n• Local erythema\n• Tenderness\n• Lymphangitis\n• Regional lymphadenopathy\n• Generalized malaise and fatigue\n• Fever\n\nDIAGNOSIS:\n• Physical evaluation\n• Blood cultures (only in immunocompromised patients with immersion injury or animal bite or signs of systemic infection)\n\nDIFFERENTIAL DIAGNOSIS:\n• Chronic venous stasis dermatitis\n• Necrotizing fasciitis\n• Septic arthritis\n• Deep vein thrombosis",
      colorsItem: Colors.red,
      Bgcolor: Colors.white,
      panelcol: Colors.white,
      colorsbody: Colors.black,
    ...
    ItemModel(
      ...
      colorsbody: Colors.black,
      discription:
          "ADULT\n\nLikely Causative Organisms:\n• Streptococcus pyogenes(common)\n• S.aureus\n\nEmpirical/First Line:\n• Amoxicillin-Clavulanate 1.2gm IV TDS/625 mg oral TDS\n Or\n• Ceftriaxone 2gm IV OD\n\nAlternative/Second Line:\n• Clindamycin 600-900mg IV TDS\n\nComments:\n• Treat for 5-7 days\n\nPEDIATRIC\n\nEmpirical/First Line:\n• Cloxacillin (50-100 mg/kg/d) in 3-4 divided doses\n Or\n• Co- Amoxy-Clav\n Or\n• Cefazolin (50 mg/Kg/d in 6-8 h doses)\n\nAlternative/Second Line:\n• Clindamycin (20-40mg/Kg/d in 6-8 hly doses)\n\nComments:\n• Treat for 5-7 days",
      img: '',
      //'assets/d1alt.png',
    ),
  ];
